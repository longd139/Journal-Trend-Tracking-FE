      ...
      {!expanded ? (
        ...
        <button
          ...
          className="flex items-center gap-2.5 px-4 py-2.5 rounded-full shadow-lg border text-xs font-semibold transition-all cursor-pointer
            bg-white dark:bg-[#1B2235] border-gray-200 dark:border-white/10 text-gray-900 dark:text-white hover:shadow-xl"
        >
          {!isAllDone ? (
        ...
        /* ── Expanded card ── */
        <div className="w-72 rounded-xl shadow-xl border overflow-hidden bg-white dark:bg-[#1B2235] border-gray-200 dark:border-white/10">
          {/* Header */}
