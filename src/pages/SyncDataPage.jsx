    ...
    >
      ...
      {result.data && Object.keys(result.data).length > 0 && (
        <div className="space-y-1.5">
          <div className="bg-gray-50 dark:bg-[#0B1020]/50 border border-gray-200 dark:border-white/5 rounded-lg p-3">
      ...
      {rawOpen && (
        <pre className="p-3 rounded-lg bg-gray-50 dark:bg-[#0B1020]/50 border border-gray-200 dark:border-white/5 text-gray-700 dark:text-slate-300 text-[11px] overflow-x-auto font-mono max-h-40 overflow-y-auto">
...
export default function SyncDataPage() {
  ...
  return (
    <div className="p-6 space-y-6 max-w-3xl mx-auto">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="flex-1 space-y-1.5">
            <label className="text-[10px] font-semibold uppercase tracking-wider text-gray-500 dark:text-[#A0AEC0]">
              Search Query
            </label>
            <div className="relative">
              ...
              <Input
                ...
                className="pl-9 pr-4 py-2.5 rounded-lg text-sm bg-white dark:bg-[#131A2A] border-gray-200 dark:border-white/10 text-gray-900 dark:text-slate-200"
              />
            </div>
          </div>
          ...
          <div className="w-full sm:w-28 space-y-1.5">
            ...
            <Input
              ...
              className="py-2.5 rounded-lg text-sm text-center bg-white dark:bg-[#131A2A] border-gray-200 dark:border-white/10 text-gray-900 dark:text-slate-200"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          <span className="text-[10px] font-semibold uppercase tracking-wider text-gray-500 dark:text-[#A0AEC0] shrink-0">
            Year
          </span>
          <select
            value={yearFrom}
            onChange={(e) => setYearFrom(e.target.value)}
            className="w-24 py-2 rounded-lg text-sm text-center bg-white dark:bg-[#131A2A] border border-gray-200 dark:border-white/10 text-gray-900 dark:text-slate-200 outline-none focus:border-emerald-500/50 transition-colors cursor-pointer"
          >
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-3.5 py-2.5 rounded-lg border text-xs font-semibold transition-all ${
                    isSelected
                      ...
                      : 'bg-gray-50 dark:bg-white/[0.03] border-gray-200 dark:border-white/10 text-gray-400 dark:text-slate-500 hover:text-gray-600 dark:hover:text-slate-300 hover:border-gray-300 dark:hover:border-white/20'
                  }`}
                >
                  <Icon size={16} />
                  {label}
      ...
      {/* ── Auto Sync ── */}
      <div className={`border-t border-gray-200 dark:border-white/5 pt-6 mt-2 ${isRunning || isBulkSyncing || isClearing ? 'opacity-50 pointer-events-none' : ''}`}>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className={`${card} p-5`}
        >
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-sm font-bold text-gray-900 dark:text-white">Auto Sync</h4>
                <p className="text-xs text-gray-500 dark:text-slate-400">
      ...
      {/* ── Bulk Sync ── */}
      <div className={`border-t border-gray-200 dark:border-white/5 pt-6 mt-2 ${isRunning || isClearing ? 'opacity-50 pointer-events-none' : ''}`}>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          className={`${card} p-5`}
        >
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-900 dark:text-white">Bulk Sync</h4>
              <p className="text-xs text-gray-500 dark:text-slate-400">
            ...
            <div className="space-y-3 mb-4">
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full p-3 rounded-lg text-xs bg-white dark:bg-[#131A2A] border border-gray-200 dark:border-white/10 text-gray-900 dark:text-slate-200 outline-none focus:border-amber-500/50 transition-colors resize-none"
                />
              </div>
                ...
                <div className="flex items-end gap-2">
                  <div className="space-y-1.5">
                    ...
                    <select
                      ...
                      className="w-24 py-2 rounded-lg text-sm text-center bg-white dark:bg-[#131A2A] border border-gray-200 dark:border-white/10 text-gray-900 dark:text-slate-200 outline-none focus:border-amber-500/50 transition-colors cursor-pointer"
                    >
          ...
          {isBulkSyncing && bulkProgress && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="mt-4 space-y-3 border-t border-gray-100 dark:border-white/5 pt-4"
            >
              {/* Percent + status */}
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
              ...
              {bulkProgress.keywordStats && Object.keys(bulkProgress.keywordStats).length > 0 && (
                <div className="bg-gray-50 dark:bg-[#0B1020]/50 border border-gray-200 dark:border-white/5 rounded-lg p-3 max-h-48 overflow-y-auto">
                  <table className="w-full text-xs">
                    <thead>
                    ...
                    <tbody>
                      {Object.entries(bulkProgress.keywordStats).map(([kw, stats]) => (
                        <tr key={kw} className="border-b border-gray-100 dark:border-white/[0.03] last:border-b-0">
                          ...
                          <td className="py-1.5 text-right font-mono text-blue-600 dark:text-blue-400">{stats.inserted}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
      ...
      {/* ── Clear All Data ── */}
      <div className={`border-t border-gray-200 dark:border-white/5 pt-6 mt-2 ${isRunning || isBulkSyncing ? 'opacity-50 pointer-events-none' : ''}`}>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      <Dialog open={showClearDialog} onOpenChange={setShowClearDialog}>
        <DialogContent className="sm:max-w-md bg-white dark:bg-[#1B2235] border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white">
          <DialogHeader>
          ...
          <DialogFooter className="gap-2">
            <Button
              ...
              disabled={isClearing || isRunning || isBulkSyncing}
              className="text-xs bg-white dark:bg-white/[0.02] border-gray-200 dark:border-white/10 text-gray-700 dark:text-slate-300"
            >
              Cancel
            </Button>
            <Button
