    ...
    <div className="bg-amber-950/40 border border-amber-500/30 text-amber-200 p-4 rounded-xl flex items-start gap-3 shadow-sm mb-5">
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs text-amber-300/80 leading-relaxed">
          You have used <strong className="text-amber-400">{searchCount}</strong>/{maxLimit} searches this month. 
          Upgrade to a <span className="underline font-bold text-amber-300 cursor-pointer hover:text-amber-100">Researcher</span> plan to unlock advanced filters.
        </p>
      </div>
    </div>
  );
