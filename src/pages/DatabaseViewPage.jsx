  ...
  if (error) {
    return (
      <div className="p-6 flex flex-col items-center justify-center min-h-[400px] text-center gap-3">
        ...
        <h3 className="text-sm font-bold text-gray-900 dark:text-white">Failed to load stats</h3>
  ...
  return (
    <div className="p-6 space-y-5">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <StatCard label="Papers" value={papers?.total} icon={FileText} accent="#4F8CFF" />
        <StatCard label="Authors" value={authors?.total} icon={Users} accent="#8B5CF6" />
        <StatCard label="Keywords" value={keywords?.total} icon={Hash} accent="#00D1B2" />
        <StatCard label="Journals" value={journals?.total} icon={BookOpen} accent="#F59E0B" />
      </div>
      ...
      <Section title="Sync Logs" icon={Clock} accent="#F59E0B">
        <div className="flex items-center gap-4">
          ...
          <div className="p-3 rounded-lg bg-gray-50 dark:bg-white/[0.02] text-center flex-1">
            ...
            <div className="text-[9px] uppercase tracking-wider text-gray-500 dark:text-[#A0AEC0] mt-0.5 flex items-center justify-center gap-1">
              <Clock size={10} />
              Last Sync
            </div>
          </div>
