...
const OverviewController = lazy(() => import('../pages/OverviewController.jsx')); 
...
const FallbackLoading = () => (
  <div className="flex h-screen w-full items-center justify-center bg-[#0B1020]">
    <div className="text-sm font-semibold text-white animate-pulse">Loading system...</div>
  </div>
);
...
export const router = createBrowserRouter([
  ...
  { 
    path: '/', 
    errorElement: <Suspense fallback={<FallbackLoading />}><NotFoundPage /></Suspense>,
    element: <Suspense fallback={<FallbackLoading />}><LandingPage /></Suspense> 
  },
  { path: '/auth', element: <Suspense fallback={<FallbackLoading />}><AuthPage /></Suspense> },
  { path: '/login', element: <Suspense fallback={<FallbackLoading />}><LoginPage /></Suspense> },
  { path: '/register', element: <Suspense fallback={<FallbackLoading />}><RegisterPage /></Suspense> },
      ...
      },
      {
        ...
        element: (
          <ProtectedRoute allowedRoles={['researcher', 'academic']}>
            <Suspense fallback={<FallbackLoading />}><BookmarksView /></Suspense>
          </ProtectedRoute>
        ),
      },
      {
        path: 'overview', // -> URL thực tế: /:roleName/overview
        element: <Suspense fallback={<FallbackLoading />}><OverviewController /></Suspense>,
      },
      {
        path: 'search', // -> URL thực tế: /:roleName/search
        element: (
          <ProtectedRoute allowedRoles={['researcher', 'academic']}>
            <Suspense fallback={<FallbackLoading />}><SearchPapers /></Suspense>
          </ProtectedRoute>
        ),
      },
      {
        ...
        element: (
          <ProtectedRoute allowedRoles={['researcher']}>
            <Suspense fallback={<FallbackLoading />}><AnalyticsView /></Suspense>
          </ProtectedRoute>
        ),
      },
      {
        ...
        element: (
          <ProtectedRoute allowedRoles={['researcher', 'academic']}>
            <Suspense fallback={<FallbackLoading />}><ReportsView /></Suspense>
          </ProtectedRoute>
        ),
      },
      // --- CÁC TRANG CỦA ADMIN ---
      {
        ...
        element: (
          <ProtectedRoute allowedRoles={['admin']}>
            <Suspense fallback={<FallbackLoading />}><UserManagement /></Suspense>
          </ProtectedRoute>
        ),
      },
      {
        ...
        element: (
          <ProtectedRoute allowedRoles={['admin']}>
            <Suspense fallback={<FallbackLoading />}><APIMonitoring /></Suspense>
          </ProtectedRoute>
        ),
      },
      {
        ...
        element: (
          <ProtectedRoute allowedRoles={['admin']}>
            <Suspense fallback={<FallbackLoading />}><DatabaseView /></Suspense>
          </ProtectedRoute>
        ),
      },
    ],
  ...
  {
    path: '*',
    element: <Suspense fallback={<FallbackLoading />}><NotFoundPage /></Suspense>
  }
]);