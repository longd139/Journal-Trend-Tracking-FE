...
function StatusBadge({ status }) {
  const cls = STATUS_STYLES[status] || 'bg-gray-500/10 text-muted-foreground border-gray-500/20';
        ...
        >
          ...
          >
            <div className="flex items-center justify-between px-6 py-4 border-b border-primary/10 shrink-0">
              ...
              <button onClick={onClose} className="p-1 rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted/40 transition-colors">
                <X size={16} />
              </button>
            </div>
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-black text-foreground font-display">PDF Requests</h1>
        ...
        <button
          ...
          disabled={loading}
          className="p-2.5 rounded-xl bg-muted/25 border border-primary/10 text-muted-foreground hover:text-foreground active:scale-[0.97] transition-all duration-150"
        >
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-primary/10 text-left">
                <th className="px-4 py-3 text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Requestor</th>
                <th className="px-4 py-3 text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Paper</th>
                <th className="px-4 py-3 text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Journal</th>
                <th className="px-4 py-3 text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Status</th>
                <th className="px-4 py-3 text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Requested</th>
                <th className="px-4 py-3 text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Admin Note</th>
                <th className="px-4 py-3 text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Actions</th>
              </tr>
            </thead>
            <tbody>
              {loading ? (
                ...
                requests.map((req) => {
                  ...
                  return (
                    <tr
                      key={req.requestId}
                      className="border-b border-border hover:bg-muted/15 transition-colors"
                    >
                      {/* Requestor */}
                      <td className="px-4 py-3">
                        <div className="flex flex-col">
                          ...
                          {req.requestedByName && (
                            <span className="text-[10px] text-muted-foreground">{req.requestedByEmail}</span>
                          )}
                        </div>
                      </td>
                        ...
                        {req.status === 'pending' ? (
                          <div className="flex items-center gap-1.5">
                            <button
                              ...
                              className="p-1.5 rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted/40 disabled:opacity-30 active:scale-[0.90] transition-all duration-150"
                            >
          ...
          <div className="flex items-center justify-between px-4 py-3 border-t border-primary/10">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                disabled={page === 0}
                className="p-1.5 rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted/40 disabled:opacity-30 transition-colors"
              >
                <ChevronLeft size={16} />
              </button>
              <button
      ...
      >
        <div className="space-y-4">
          {candidatesModal.request && (
            <div className="p-3 rounded-xl bg-muted/30 border border-primary/10">
              <p className="text-xs text-foreground font-medium line-clamp-2">
                {candidatesModal.request.paperTitle}
              </p>
              {candidatesModal.request.doi && (
                <p className="text-[10px] text-muted-foreground mt-1 font-mono">DOI: {candidatesModal.request.doi}</p>
              )}
            </div>
          )}
            ...
            <div className="space-y-2">
              ...
              {candidates.map((c, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="flex items-center gap-3 p-3 rounded-xl border border-primary/15 bg-card"
                  >
                    <div className="flex-1 min-w-0">
                      ...
                      {source && (
                        <div className="text-[9px] text-muted-foreground mt-0.5">Source: {source}</div>
                      )}
                    </div>
                    <button
                      onClick={() => quickFulfill(url)}
                      className="shrink-0 px-3 py-1.5 rounded-lg text-[10px] font-bold text-white bg-emerald-500 hover:bg-emerald-600 transition-colors"
                    >
                      Use this
                    </button>
                  </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[10px] font-medium text-muted-foreground uppercase tracking-wider">or upload your own PDF</span>
            <div className="flex-1 h-px bg-primary/10" />
          </div>
          ...
          {uploadFile ? (
            ...
            <div
              ...
              className="relative flex flex-col items-center justify-center gap-2 p-6 rounded-xl border-2 border-dashed border-primary/20 bg-card cursor-pointer hover:border-primary/40 hover:bg-muted/30 transition-all group"
            >
              ...
              <div className="text-center">
                ...
                <p className="text-[10px] text-muted-foreground mt-0.5">PDF only · Max 20 MB</p>
              </div>
            </div>
          )}
          ...
          {uploadFile && (
            <button
              ...
              disabled={uploading}
              className="w-full py-2.5 rounded-xl text-xs font-bold text-white bg-emerald-500 hover:bg-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2"
            >
              {uploading ? (
                <>
      ...
      >
        <div className="space-y-4">
          ...
          <div>
            ...
            {uploadFile && (
              <button
                ...
                disabled={uploading}
                className="mt-3 w-full py-2.5 rounded-xl text-xs font-bold text-white bg-emerald-500 hover:bg-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2"
              >
                {uploading ? (
                  <>
                    <Loader2 size={14} className="animate-spin" />
          ...
          <div className="flex items-center gap-3">
            <div className="flex-1 h-px bg-primary/10" />
            <span className="text-[10px] font-medium text-muted-foreground uppercase tracking-wider">or paste URL</span>
            <div className="flex-1 h-px bg-primary/10" />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2.5 rounded-lg border border-primary/20 bg-muted/25 text-xs text-foreground placeholder:text-muted-foreground outline-none focus:border-primary/40 transition-colors"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-3 py-2.5 rounded-lg border border-primary/20 bg-muted/25 text-xs text-foreground placeholder:text-muted-foreground outline-none focus:border-primary/40 transition-colors resize-none"
            />
          </div>
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            {!uploadFile && (
              <button
                ...
                className="px-4 py-2 rounded-lg text-xs font-bold text-white bg-emerald-500 hover:bg-emerald-600 disabled:opacity-50 transition-colors"
              >
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <button
              ...
              disabled={actionLoading}
              className="px-4 py-2 rounded-lg text-xs font-bold text-foreground bg-red-500 hover:bg-red-400 disabled:opacity-50 transition-colors"
            >
